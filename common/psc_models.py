...
MODELS = {
    ...
    "ALSu_1ST_ARTICLE_4-CH-SLOW_HSS": PSCModel(
            ...
            description="PSC-4-CH-SLOW_HSS",
            designation="ALSu_1ST_ARTICLE_4-CH-SLOW_HSS",
            channels=(1, 2, 3, 4),
    ...
    "ALSu_1ST_ARTICLE_4-CH-SLOW_MSS": PSCModel(
            model_id="ALSu_1ST_ARTICLE_4-CH-SLOW_MSS",
            display_name="ALSu_1ST_ARTICLE_4-CH-SLOW_MSS", # - BIPOLAR -- 33.3R/1k/2u2 BUR/COMP, 'SKQ' TUNING BRD",
            description="PSC-4-CH-SLOW_MSS",
            designation="ALSu_1ST_ARTICLE_4-CH-SLOW_MSS",
            channels=(1, 2, 3, 4),
            drive_channels=(1, 2, 3, 4),
            readback_channels=(1,2, 3, 4),
    ...
    "ALSu_1ST_ARTICLE_4-CH-FAST_HSF": PSCModel(
        model_id="ALSu_1ST_ARTICLE_4-CH-FAST_HSF",
        display_name="ALSu_1ST_ARTICLE_4-CH-FAST_HSF", # - BIPOLAR -- 33.3R/20k/0u1 BUR/COMP, 'MSF' TUNING BRD",
        description="PSC-4-CH-FAST_HSF",
        designation="ALSu_1ST_ARTICLE_4-CH-FAST_HSF",
        channels=(1, 2, 3, 4),
        drive_channels=(1, 2, 3, 4),
        readback_channels=(1,2, 3, 4),
    ...
    "ALSu_1ST_ARTICLE_2-CH-SLOW_HSS": PSCModel(
        model_id="ALSu_1ST_ARTICLE_2-CH-SLOW_HSS",
        display_name="ALSu_1ST_ARTICLE_2-CH-SLOW_HSS", #- UNIPOLAR -- 33.3R/1k/2u2 BUR/COMP, 'SKQ' TUNING BRD",
        description="PSC-2-CH-SLOW_HSS",
        designation="ALSu_1ST_ARTICLE_2-CH-SLOW_HSS",
        channels=(1, 2),
        drive_channels=(1, 2),
